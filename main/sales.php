...
<input type="text" name="qty" value="1" placeholder="Qty" autocomplete="off" style="width: 68px; padding-top: 6px; padding-bottom: 6px; margin-right: 4px;" />
<?php
	$discount = $db->prepare("SELECT discount FROM discount");
	$discount->execute();
	$discount = $discount->fetch();
?>
<input type="text" name="discount" value="<?php echo $discount['discount']; ?>" autocomplete="off" style="width: 68px; padding-top: 6px; padding-bottom: 6px; margin-right: 4px;" />
